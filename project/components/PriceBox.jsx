      ...
      <div className="relative w-[320px] lg:w-[360px] xl:w-[420px] 2xl:w-[480px] rounded-[40px] lg:rounded-[45px] xl:rounded-[50px] 2xl:rounded-[60px] bg-transparent z-10">
        ...
        <div className="relative rounded-[40px] lg:rounded-[45px] xl:rounded-[50px] 2xl:rounded-[60px] p-6 lg:p-7 xl:p-8 2xl:p-10 backdrop-blur-sm bg-transparent border border-transparent">
          ...
          <div className="relative inline-block mb-8 lg:mb-10 xl:mb-12 2xl:mb-14 group/button">
            {/* Gradient border for button on hover */}
            <div
            ...
            />
            <button
              className="relative text-white px-4 lg:px-5 xl:px-6 2xl:px-8 rounded-3xl lg:rounded-4xl text-[24px] lg:text-[27px] xl:text-[30px] 2xl:text-[36px] font-normal transition-all duration-300 h-[50px] lg:h-[55px] xl:h-[61px] 2xl:h-[70px] flex items-center justify-center cursor-pointer bg-black border-2 border-white"
              style={{ fontFamily: "Questrial, sans-serif" }}
          ...
          {bulletPoints?.length > 0 && (
            <div className="space-y-3 lg:space-y-4 2xl:space-y-5">
              {bulletPoints.map((point, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 lg:gap-4 2xl:gap-5"
                >
                  <CircleCheckBig
                    className="flex-shrink-0 w-[24px] lg:w-[28px] xl:w-[31px] 2xl:w-[36px] h-[24px] lg:h-[28px] xl:h-[31px] 2xl:h-[36px] text-white"
                  />
                  <span
